# Παρουσιάζεται η ανάπτυξη του συστήματος για την αεροπορική εταιρία μέσω του οποίου θα γίνονται διάφορες ενέργειες (κράτηση εισιτηρίων - διαγραφή εισιτηρίων κλπ) τα οποία θα παρουσιαστούν παρακάτω λεπτομερώς____Papakonstantinou_Antonis
