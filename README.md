...
# Για του λόγου το αληθές:
      ...
      - Εκτελούμε αμέσως την εντολή db.usernames.find({}) μέσα στη βάση DigitalAirlines στο cmd μας. Θα δούμε τον χρήστη antonhspap ακριβώς όπως τον περάσαμε λίγο παραπάνω , δηλαδή:
